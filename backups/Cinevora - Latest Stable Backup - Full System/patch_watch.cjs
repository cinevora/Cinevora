const fs = require('fs');
let html = fs.readFileSync('public/watch.html', 'utf8');
...
// Insert the HTML below synopsis
html = html.replace(
...
// Insert the logic
html = html.replace('// Setup Trailer button', commentsLogic + '\n        // Setup Trailer button');

fs.writeFileSync('public/watch.html', html);
console.log("watch.html patched");
